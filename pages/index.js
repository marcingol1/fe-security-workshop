      ...
      .then(snapshot => {
        snapshot.forEach(document => {
          firestore
            ...
            .delete()
            .then(function() {
              console.log('Meme has been removed!');
            })
            .catch(err => console.warn('Document was not deleted!', err));
        });
      });
  }
        ...
        return (
          <Card className={classes.card} key={user.id}>
            <CardHeader
              ...
              action={
                <IconButton
                  onClick={() => removeCard(user.data.url)}
            ...
            <CardContent>
              <Typography
                variant="subtitle1"
                color="secondary"
                dangerouslySetInnerHTML={{ __html: user.data.fileName }}
              ></Typography>
              <Typography
                variant="body2"
                color="textSecondary"
